 ...
 * @author David
 */
@Named(value = "controladorCrearProcesosSeguimiento")
@RequestScoped
public class ControladorCrearProcesosSeguimiento implements Serializable {

    private final static String UPLOAD_DIR = "/archivos/RemisionJuez";
    @EJB
    ...
    public ControladorCrearProcesosSeguimiento() {
    }
    ...
    public String crearProceso() {
        try {
            ...
            proceso.setTipoConcepto("Informe seguimiento");
