 ...
 * @author David
 */
@Named(value = "controladorCrearProcesosExtraordinario")
@RequestScoped
public class ControladorCrearProcesosExtraordinario implements Serializable {
    ...
    public ControladorCrearProcesosExtraordinario() {
    }
    ...
    public String crearProceso() {
        proceso.setTipoproceso("Seguimiento valoracion");
        proceso.setTipoConcepto("Informe extraordinario");
